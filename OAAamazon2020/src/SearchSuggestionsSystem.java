...
public class SearchSuggestionsSystem {
	...
	public static void main(String[] args) {
		...
		List<List<String>> res = new SearchSuggestionsSystem().suggestedProducts(new String[]{"mobile","mouse","moneypot","monitor","mousepad"}, "mouse");
		System.out.print(Arrays.asList(res));
	}
